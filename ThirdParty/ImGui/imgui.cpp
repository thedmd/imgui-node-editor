...
void ImGui::ItemSize(const ImVec2& size, float text_offset_y)
{
    ...
    ImGuiLayoutType layoutType = window->DC.LayoutType;
    if (window->DC.CurrentLayout)
        layoutType = window->DC.CurrentLayout->Type;

    if (layoutType == ImGuiLayoutType_Vertical)
    {
    ...
    else
    {
        ...
        window->DC.CursorPos = ImVec2(
            ...
            (float)(int)(window->DC.CursorPosPrevLine.y - size.y)
        );
...
//-----------------------------------------------------------------------------
// [SECTION] LAYOUTS
// Stack based layouts implementation able to move widget positions.
//-----------------------------------------------------------------------------
